// validate.js - StepScraper Extension Validation Script
...
console.log('🔍 StepScraper Extension Validation\n');
...
try {
    ...
    if (manifest.name === 'StepScraper') {
        console.log('✅ name - Correct');
        results.passed++;
    } else {
        console.log('❌ name - Should be "StepScraper"');
        results.failed++;
        results.errors.push('name should be "StepScraper"');
    }
